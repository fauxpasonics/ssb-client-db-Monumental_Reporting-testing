...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account__copyloa__0B91BA14] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Account] ADD CONSTRAINT [PK__Account__3214EC07DD2A1C6F] PRIMARY KEY CLUSTERED  ([Id])
GO
