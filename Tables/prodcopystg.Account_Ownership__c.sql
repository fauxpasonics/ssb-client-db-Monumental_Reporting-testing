CREATE TABLE [prodcopystg].[Account_Ownership__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Account_O__copyl__3864608B] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Account_Ownership__c] ADD CONSTRAINT [PK__Account___3214EC076FB98F1C] PRIMARY KEY CLUSTERED  ([Id])
GO
