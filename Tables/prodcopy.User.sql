...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__User__copyloadda__29221CFB] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[User] ADD CONSTRAINT [PK__User__3214EC07CBC8DA31] PRIMARY KEY CLUSTERED  ([Id])
GO
