CREATE TABLE [prodcopystg].[Lead_Source__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Lead_Sour__copyl__3B40CD36] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Lead_Source__c] ADD CONSTRAINT [PK__Lead_Sou__3214EC0785A1B3B8] PRIMARY KEY CLUSTERED  ([Id])
GO
