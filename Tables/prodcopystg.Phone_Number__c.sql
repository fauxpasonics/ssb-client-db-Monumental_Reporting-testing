CREATE TABLE [prodcopystg].[Phone_Number__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Phone_Num__copyl__14270015] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Phone_Number__c] ADD CONSTRAINT [PK__Phone_Nu__3214EC0798DB8D7A] PRIMARY KEY CLUSTERED  ([Id])
GO
