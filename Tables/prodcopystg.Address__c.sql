CREATE TABLE [prodcopystg].[Address__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Address____copyl__1CBC4616] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopystg].[Address__c] ADD CONSTRAINT [PK__Address___3214EC077E031B62] PRIMARY KEY CLUSTERED  ([Id])
GO
