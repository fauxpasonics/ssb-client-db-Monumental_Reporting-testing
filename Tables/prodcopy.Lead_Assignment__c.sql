CREATE TABLE [prodcopy].[Lead_Assignment__c]
(
...
[Worked__c] [bit] NULL,
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Lead_Assi__copyl__40F9A68C] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[Lead_Assignment__c] ADD CONSTRAINT [PK__Lead_Ass__3214EC0705898018] PRIMARY KEY CLUSTERED  ([Id])
GO
