CREATE TABLE [prodcopy].[Email_Address__c]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Email_Add__copyl__22751F6C] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[Email_Address__c] ADD CONSTRAINT [PK__Email_Ad__3214EC0714457768] PRIMARY KEY CLUSTERED  ([Id])
GO
